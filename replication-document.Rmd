...
Great summary of paper and abstract.
...
# I know gt is probably new to you (it is to me too!) but in the future
# would definitely like to see some more formatting of this table
# in the column headers, footnotes from original paper, and rounded numbers so
# the table fits
...
# Same as above, good table, glad to see you're trying out gt, definitely want to
# see if you can make it look a little more, or better, than what's in the paper
```
